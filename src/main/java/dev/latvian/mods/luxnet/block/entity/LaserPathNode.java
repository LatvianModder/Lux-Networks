package dev.latvian.mods.luxnet.block.entity;

import dev.latvian.mods.luxnet.block.LaserDevice;
 ...
 */
public class LaserPathNode implements Iterable<LaserPathNode>
{
	private static class PathIterator implements Iterator<LaserPathNode>
	{
		private LaserPathNode node;

		private PathIterator(LaserPathNode n)
		{
			node = n;
		}
		...
		@Override
		public LaserPathNode next()
		{
			LaserPathNode n = node;
	...
	public LaserPathNode next = null;
	...
	public boolean equals(Object obj)
	{
		...
		else if (obj instanceof LaserPathNode)
		{
			LaserPathNode r = (LaserPathNode) obj;
	...
	@Override
	public Iterator<LaserPathNode> iterator()
	{
