 ...
 */
public class LaserEmitterEntity extends TileEntity
{
	public UUID owner;
	public LaserPathNode path;

	public LaserEmitterEntity()
	{
		super(LuxNetBlockEntities.LASER_EMITTER);
	...
	public void read(CompoundNBT nbt)
	{
		...
		if (!list.isEmpty())
		{
			...
			LaserPathNode prev = path;

			for (int i = 1; i < list.size(); i++)
			{
				CompoundNBT nbt2 = list.getCompound(i);
				prev.next = new LaserPathNode();
